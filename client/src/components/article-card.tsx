...
export function ArticleCard({ article, perspective, onReadMore }: ArticleCardProps) {
  ...
  return (
    ...
    >
      <Card className="glass-card olive-border rounded-xl overflow-hidden">
        <CardContent className="p-6">
          ...
          <div className="flex items-center space-x-3 mb-3">
            <span className="text-sm font-medium px-2 py-1 rounded olive-tag">
              {article.source}
            </span>
          ...
          <h4 
            className="text-xl font-semibold mb-3 text-ivory hover:text-olive transition-colors cursor-pointer line-clamp-2"
            onClick={() => onReadMore(article)}
          >
            {article.title}
          </h4>
          
          <p className="text-sage mb-4 line-clamp-3">
            {article.content}
          </p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-sage">{article.viewCount} views</span>
            </div>
            <Button
              variant="ghost"
              size="sm"
